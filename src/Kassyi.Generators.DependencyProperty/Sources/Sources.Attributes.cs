...
internal static partial class SourceGenerationHelper
{
    ...
    private static string GenerateCategoryAttribute(string? value)
    {
        ...
        {
            null => " ",
            _ => GenerateComponentModelAttribute(nameof(DependencyPropertyData.Category), $"\"{value}\"")
        };
    }
    ...
    private static string GenerateTypeConverterAttribute(string? value)
    {
        ...
        {
            null => " ",
            _ => GenerateComponentModelAttribute(nameof(DependencyPropertyData.TypeConverter),
    ...
    private static string GenerateDesignerSerializationVisibilityAttribute(string? value)
    {
        ...
        {
            null => " ",
            _ => GenerateComponentModelAttribute(nameof(DependencyPropertyData.DesignerSerializationVisibility),
    ...
    {
        return GenerateAttribute("System.CodeDom.Compiler.GeneratedCode",
