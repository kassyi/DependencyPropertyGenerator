...
propertyType: typeof((int id, string name)),
ownerType: typeof(MyControl),
typeMetadata: new global::System.Windows.FrameworkPropertyMetadata(
    defaultValue: default((int id, string name)),
...
public (int id, string name) MyProperty
{
get => ((int id, string name))GetValue(MyPropertyProperty);
