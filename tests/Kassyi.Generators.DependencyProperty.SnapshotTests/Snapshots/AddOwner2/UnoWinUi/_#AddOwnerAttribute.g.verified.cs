...
internal sealed class AddOwnerAttribute : global::System.Attribute
{
    ...
    /// <summary>Default value expression of this dependency property. Used to pass a new() expression to an initializer. Default - <see langword="null"/>.</summary>
    public string? DefaultValueExpression { get; set; }
    /// <summary>The property will create through RegisterAttachedReadOnly (if the platform supports it) and the property setter will contain the protected modifier. Default - <see langword="false"/>.</summary>
    ...
    /// <summary>The type that owns the original Dependency Property. Required.</summary>
    public global::System.Type? FromType { get; }
    /// <summary>The dependency property xml documentation. Default - "&lt;summary&gt; &lt;/summary&gt;".</summary>
    public string XmlDocumentation { get; set; } = string.Empty;
    /// <summary>The property getter xml documentation. Default - "&lt;summary&gt; &lt;/summary&gt;".</summary>
    public string GetterXmlDocumentation { get; set; } = string.Empty;
    /// <summary>The property setter xml documentation. Default - "&lt;summary&gt; &lt;/summary&gt;".</summary>
    public string SetterXmlDocumentation { get; set; } = string.Empty;
    /// <summary>For values other than default(type), will bind/rebind/remove the On{Name}Changed_{EventName}(object sender, Args args) handler for the specified event. It is recommended to specify as nameof(UIElement.Drop). Default - string.Empty.</summary>
    public string BindEvent { get; set; } = string.Empty;
    /// <summary>For values other than default(type), will bind/rebind/remove the On{Name}Changed_{EventName}(object sender, Args args) handler for the specified event. It is recommended to specify as nameof(UIElement.Drop). Default - <see langword="null"/>.</summary>
    public string[]? BindEvents { get; set; }
    /// <summary>Allows to set a custom name for the OnChanged method call, allowing this method to be non-partial.</summary>
    public string OnChanged { get; set; } = string.Empty;
    /// <summary>WPF: The measure pass of layout compositions is affected by value changes to this dependency property.</summary>
    public bool AffectsMeasure { get; set; }
    /// <summary>WPF: The arrange pass of layout composition is affected by value changes to this dependency property.</summary>
    public bool AffectsArrange { get; set; }
    /// <summary>WPF: The measure pass on the parent element is affected by value changes to this dependency property.</summary>
    public bool AffectsParentMeasure { get; set; }
    /// <summary>WPF: The arrange pass on the parent element is affected by value changes to this dependency property.</summary>
    public bool AffectsParentArrange { get; set; }
    /// <summary>WPF: Some aspect of rendering or layout composition (other than measure or arrange) is affected by value changes to this dependency property.</summary>
    public bool AffectsRender { get; set; }
    /// <summary>WPF: The values of this dependency property are inherited by child elements.</summary>
    public bool Inherits { get; set; }
    /// <summary>WPF: The values of this dependency property span separated trees for purposes of property value inheritance.</summary>
    public bool OverridesInheritanceBehavior { get; set; }
    /// <summary>WPF: Data binding to this dependency property is not allowed.</summary>
    public bool NotDataBindable { get; set; }
    /// <summary>WPF: The values of this dependency property should be saved or restored by journaling processes, or when navigating by Uniform resource identifiers (URIs).</summary>
    public bool Journal { get; set; }
    /// <summary>WPF: The sub properties on the value of this dependency property do not affect any aspect of rendering.</summary>
    public bool SubPropertiesDoNotAffectRender { get; set; }
    /// <summary>WPF: true to prevent the property system from animating the property that this metadata is applied to. Such properties will raise a run-time exception originating from the property system if animations of them are attempted. The default is false.</summary>
    public bool IsAnimationProhibited { get; set; }
    /// <summary>WPF: The System.Windows.Data.UpdateSourceTrigger to use when bindings for this property are applied that have their System.Windows.Data.UpdateSourceTrigger set to System.Windows.Data.UpdateSourceTrigger.Default.</summary>
    public SourceTrigger DefaultUpdateSourceTrigger { get; set; }
    /// <summary>Avalonia/MAUI: Default BindingMode. WPF: Only Default/TwoWay is supported. Default - <see cref = "DefaultBindingMode.Default"/>.</summary>
    public DefaultBindingMode DefaultBindingMode { get; set; } = DefaultBindingMode.Default;
    /// <summary>WPF: partial method for coerceValueCallback will be created.</summary>
    public bool Coerce { get; set; }
    /// <summary>WPF: partial method for validateValueCallback will be created.</summary>
    public bool Validate { get; set; }
    /// <summary>UWP/WinUI/Uno/MAUI: partial method for createDefaultValueCallback will be created.</summary>
    public bool CreateDefaultValueCallback { get; set; }

    public AddOwnerAttribute(string name, global::System.Type type, global::System.Type fromType)
    {
...
internal sealed class AddOwnerAttribute<T, TFromType> : global::System.Attribute
{
    ...
    public AddOwnerAttribute(string name)
    {
        Name = name ?? throw new global::System.ArgumentNullException(nameof(name));
        Type = typeof(T);
