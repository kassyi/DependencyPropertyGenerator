...
global::Avalonia.AvaloniaProperty.Register<MyControl, string>(name: "NotNullStringProperty",
defaultValue: (string)"",
inherits: false,
defaultBindingMode: global::Avalonia.Data.BindingMode.OneWay,
validate: static value => IsNotNullStringPropertyValid((string?)value),
coerce: static (sender, value) => ((MyControl)sender).CoerceNotNullStringProperty((string?)value));
