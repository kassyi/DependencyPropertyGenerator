...
global::System.Windows.DependencyProperty.Register(name: "NotNullStringProperty",
...
((MyControl)sender).OnNotNullStringPropertyChanged((string)args.OldValue, (string)args.NewValue);
    ...
    coerceValueCallback: static (sender, value) => ((MyControl)sender).CoerceNotNullStringProperty((string?)value),
    isAnimationProhibited: false),
validateValueCallback: static value => IsNotNullStringPropertyValid((string?)value));
