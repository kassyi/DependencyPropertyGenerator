...
global::Microsoft.Maui.Controls.BindableProperty.Create(propertyName: "NotNullStringProperty",
returnType: typeof(string),
declaringType: typeof(MyControl),
defaultValue: (string)"",
defaultBindingMode: global::Microsoft.Maui.Controls.BindingMode.OneWay,
validateValue: static (sender, value) => IsNotNullStringPropertyValid((MyControl)sender, (string?)value),
propertyChanged: static (sender, oldValue, newValue) =>
{
((MyControl)sender).OnNotNullStringPropertyChanged();
((MyControl)sender).OnNotNullStringPropertyChanged((string)newValue);
((MyControl)sender).OnNotNullStringPropertyChanged((string)oldValue, (string)newValue);
},
propertyChanging: static (sender, oldValue, newValue) =>
{
((MyControl)sender).OnNotNullStringPropertyChanging();
((MyControl)sender).OnNotNullStringPropertyChanging((string)newValue);
((MyControl)sender).OnNotNullStringPropertyChanging((string)oldValue, (string)newValue);
},
coerceValue: static (sender, value) => ((MyControl)sender).CoerceNotNullStringProperty((string?)value),
