...
namespace Kassyi.Generators.DependencyProperty.IntegrationTests
{
    public partial class MyControl
    {
        ...
        public static readonly global::Microsoft.Maui.Controls.BindableProperty AttributedPropertyProperty = global::Microsoft.Maui.Controls.BindableProperty.Create(propertyName: "AttributedProperty", returnType: typeof(string), declaringType: typeof(MyControl), defaultValue: default(string), defaultBindingMode: global::Microsoft.Maui.Controls.BindingMode.OneWay, validateValue: null, propertyChanged: static (sender, oldValue, newValue) =>
        {
            ((MyControl)sender).OnAttributedPropertyChanged();
            ((MyControl)sender).OnAttributedPropertyChanged((string? )newValue);
            ((MyControl)sender).OnAttributedPropertyChanged((string? )oldValue, (string? )newValue);
        }, propertyChanging: static (sender, oldValue, newValue) =>
        {
            ((MyControl)sender).OnAttributedPropertyChanging();
            ((MyControl)sender).OnAttributedPropertyChanging((string? )newValue);
            ((MyControl)sender).OnAttributedPropertyChanging((string? )oldValue, (string? )newValue);
