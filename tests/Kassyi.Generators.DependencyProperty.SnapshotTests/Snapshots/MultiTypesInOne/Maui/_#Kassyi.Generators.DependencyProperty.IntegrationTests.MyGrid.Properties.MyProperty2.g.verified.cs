...
namespace Kassyi.Generators.DependencyProperty.IntegrationTests
{
    public partial class MyGrid
    {
        ...
        public static readonly global::Microsoft.Maui.Controls.BindableProperty MyProperty2Property = global::Microsoft.Maui.Controls.BindableProperty.Create(propertyName: "MyProperty2", returnType: typeof(int), declaringType: typeof(MyGrid), defaultValue: default(int), defaultBindingMode: global::Microsoft.Maui.Controls.BindingMode.OneWay, validateValue: null, propertyChanged: static (sender, oldValue, newValue) =>
        {
            ((MyGrid)sender).OnMyProperty2Changed();
            ((MyGrid)sender).OnMyProperty2Changed((int)newValue);
            ((MyGrid)sender).OnMyProperty2Changed((int)oldValue, (int)newValue);
        }, propertyChanging: static (sender, oldValue, newValue) =>
        {
            ((MyGrid)sender).OnMyProperty2Changing();
            ((MyGrid)sender).OnMyProperty2Changing((int)newValue);
            ((MyGrid)sender).OnMyProperty2Changing((int)oldValue, (int)newValue);
