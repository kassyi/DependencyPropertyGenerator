...
global::Microsoft.Maui.Controls.BindableProperty.Create(propertyName: "MyProperty",
...
((MyControl)sender).OnMyPropertyChanged((int)newValue);
((MyControl)sender).OnMyPropertyChanged((int)oldValue, (int)newValue);
},
propertyChanging: static (sender, oldValue, newValue) =>
{
((MyControl)sender).OnMyPropertyChanging();
((MyControl)sender).OnMyPropertyChanging((int)newValue);
((MyControl)sender).OnMyPropertyChanging((int)oldValue, (int)newValue);
},
coerceValue: null,
...
public required partial int MyProperty
{
get => (int)GetValue(MyPropertyProperty);
init => SetValue(MyPropertyProperty, value);
